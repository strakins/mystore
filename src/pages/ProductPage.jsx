...
const ProductPage = () => {
  ...
  return (
    <>
    {
        ItemLists.filter((item) => item.id == id).map((item, index) => {
            return (
                <div className="bg-gray-100" key={index}>
                                    <div className="container mx-auto px-4 py-8">
                                        ...
                                        <div className="w-full md:w-1/2 px-4">
                                            ...
                                            <span className="text-gray-500 line-through">${item.priceSlash}</span>
                                            </div>
        ...
        <div className="fixed inset-0 z-40 min-h-full overflow-y-auto overflow-x-hidden transition flex items-center">
                ...
                <div className="relative w-full cursor-pointer pointer-events-none transition my-auto p-4">
                    <div
                        ...
                        <button  type="button" className="absolute top-2 right-2 rtl:right-auto rtl:left-2" onClick={() => setShowModal(false)}>
                        ...
                        <div className="space-y-2 p-2">
                            <div className="p-4 space-y-2 text-center dark:text-white">
                                ...
                                <p className="text-gray-500">
                                    Are you sure you would like to Add to Cart?
                                </p>
                            </div>
                        </div>
